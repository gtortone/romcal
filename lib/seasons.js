...
var Dates = require( Path.join( __dirname, 'dates' )),
...
var _epiphany = function() {
  ...
  var before = Dates.daysBeforeEpiphany.apply( this, arguments ),
      after = Dates.daysAfterEpiphany.apply( this, arguments ),
      days = [];

  _.each( before, function( day ) {
    days.push({
      moment: day,
      type: _.last( Types ),
      name: Utils.localize({
...
var _holyWeek = function() {
  ...
  var d = Dates.holyWeek.apply( this, arguments ),
      days = [];
...
// arguments[0]: Takes the year (integer)
var _advent = function() {

  var days = [];
  _.each( Dates.daysOfAdvent.apply( this, arguments ), function( value, i  ) {
    days.push({
      moment: value,
  ...
  days = _.sortBy( days, function( item ) {
...
var _christmastide = function() {

  var days = Dates.christmastide.apply( this, arguments ),
      octave = Dates.octaveOfChristmas( arguments[0] ),
      epiphany = _epiphany( ( arguments[0] + 1 ), arguments[2] );
  ...
  var o = []
  _.each( octave, function( day, idx ) {
    o.push({
      moment: day,
...
// arguments[1]: t|o|e [The mode to calculate the end of Christmastide]
// arguments[2]: true|false [If true, Epiphany will be fixed to Jan 6]
var _earlyOrdinaryTime = function() {

  var days = [];
  _.each( Dates.daysOfEarlyOrdinaryTime.apply( this, arguments ), function( value, i ) {
    days.push({
      moment: value,
...
// arguments[0]: year
var _laterOrdinaryTime = function() {
  ...
  var days = [];
  _.each( Dates.daysOfLaterOrdinaryTime.apply( this, arguments ).reverse(), function( value, i ) {
...
var _lent = function() {
  ...
  var d = Dates.daysOfLent.apply( this, arguments ),
...
// arguments[0]: Takes the year (integer)
var _easterTriduum = function() {

  var d = _holyWeek.apply( this, arguments ),
...
// arguments[0]: Takes the year (integer)
var _easterOctave = function() {

  var d = _eastertide.apply( this, arguments ),
      days = _.take( d, 8 );
...
// arguments[0]: Takes the year (integer)
var _eastertide = function() {

  var d = Dates.daysOfEaster( arguments[0] ),
...
module.exports = {
  advent: _advent,
  christmastide: _christmastide,
  earlyOrdinaryTime: _earlyOrdinaryTime,
  lent: _lent,
  easterTriduum: _easterTriduum,
  easterOctave: _easterOctave,
  eastertide: _eastertide,
  laterOrdinaryTime: _laterOrdinaryTime
};
